...
// ✅ useScroll aur useTransform ko waapas import karein
import { motion, useScroll, useTransform, AnimatePresence } from 'framer-motion';
import { Trophy } from 'lucide-react';

// Data and Type imports
import { Tab, CoCStats, ClanMember, WarLogEntry, CurrentWar } from '../data';
...
const GamezoneClient: React.FC<GamezoneClientProps> = ({ tabs, clanInfo, warLog, currentWar }) => {
    const [activeTab, setActiveTab] = useState('favorites');

    // ✅ Parallax scroll hooks waapas add kiye gaye
    const { scrollYProgress } = useScroll();
    const y = useTransform(scrollYProgress, [0, 1], ['0%', '50%']);

    return (
        <>
            {/* ✅ Hero Section waapas add kiya gaya */}
