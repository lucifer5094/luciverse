...
export default function Home() {
  ...
  const [heroSubtitle, setHeroSubtitle] = useState(
    "Dive into my universe of development, design, and digital experiments"
  );
  ...
  return (
    <div ref={containerRef} className="relative overflow-hidden">
      ...
      <div className="fixed inset-0 -z-10">
        ...
        {/* Geometric shapes */}
        <div
          className="absolute top-20 right-20 w-32 h-32 border border-accent/10 rounded-lg rotate-45 animate-spin"
          style={{ animationDuration: "20s" }}
        ></div>
        <div
          className="absolute bottom-32 left-20 w-24 h-24 border border-accentone/10 rounded-full animate-ping"
      ...
      <main className="min-h-screen flex flex-col justify-center items-center px-4 py-16 bg-gradient-to-br from-light-background via-white to-gray-50 dark:from-dark-surface dark:via-dark-background dark:to-black transition-colors duration-300">
        ...
        >
          ...
          >
            ...
            >
              <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto relative leading-relaxed">
                Recent achievements, featured projects, and notable milestones
          ...
          {highlights.length === 0 ? (
            ...
            >
              ...
              >
                This space will showcase amazing work highlights, achievements,
                ...
                .map((highlight: any, index: number) => (
                  ...
                  >
                    ...
                    <motion.div
                      ...
                      style={{
                        background:
                          "linear-gradient(135deg, rgba(79, 70, 229, 0.1), rgba(236, 72, 153, 0.1), rgba(79, 70, 229, 0.1))",
                      }}
                      animate={{
        ...
        >
          {[
            ...
            (
              { title, path, icon, description, gradient, accentColor },
              index
            ) => (
              <motion.div
                key={path}
        ...
        >
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-accent/10 via-purple-500/10 to-accentone/10 backdrop-blur-sm border border-white/20 dark:border-gray-700/50 shadow-2xl p-12">
            ...
            <div className="relative z-10 text-center">
              ...
              >
                Ready to collaborate on something amazing? Let&apos;s discuss
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                >
                  ...
                  that blend creativity with cutting-edge technology. From web
                  applications to experimental projects, I explore the
        ...
        >
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-purple-500/10 via-pink-500/10 to-orange-500/10 backdrop-blur-sm border border-white/20 dark:border-gray-700/50 shadow-xl p-8 md:p-12">
            ...
            <div className="relative z-10 text-center">
              ...
              >
                Step into my digital laboratory where ideas come to life.
                Interactive demos, experimental features, and playground
                projects await your exploration.
              </motion.p>
